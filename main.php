	...
	<div class="container-fluid">
		...
		<nav class="navbar navbar-expand-lg navbar-fixed-top">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="#"><img width="40px" class=" img-rounded margin:3px" src="img/infiitilogo.png"><b class="margin-left:40px">I N F I N I T I</b><h2>SOFTWARE SOLUTIONS</h2></a>
				</div>
					<div id="mynavbar " class="collapse navbar-collapse">
						<ul class=" nav navbar-nav navbar-right">
							...
							<li class="navbar " ><a href="contect.php" ><i class=" glyphicon-info"></i> About Us</a>
						</ul>
					</div>
...
<div class="row">
		<div class=col-md-4>
			<img src="img/AYP.png" width="100px">
			</div>
			<div class=col-md-4>
			<img src="img/Agency-Auto-Icon.png" width="100px">
			</div>
			<div class=col-md-4>
			<br>
			<img src="img/Craft.png" width="100px">
			</div>
			
			</div>
<footer>
<div class="jumbotron jumbotron-foot text-center color:primary">
	<div><class="text-success font-size:22px color:#25d0d2" behavior="scroll" direction="left">BUSINESS TRAVEL MANAGEMENT SOLUTION <b>|&nbsp;&nbsp;</b> EXPENSE MANAGEMENT SOLUTION <b>|&nbsp;&nbsp;</b>GROUP REVENUE MANAGEMENT<b>|&nbsp;&nbsp;</b>AIRLINE FORECASTING TOOL<b>|&nbsp;&nbsp;</b>AIRLINE SME SOLUTION</div>
  ...
  <p class="left-align:10px">Posted by: Infiniti Softnet</p>
  <p class="left-align:10px">Contact information: <a href="abc@gmail.com">
  abc@gmail.in</a>.</p>
  </div>
