...
<div class="row">
		<div class=col-md-2>
			...
			<br>
			<br>
			<img src="img/GroupRm.png" width="100px">
			</div>
			<div class=col-md-2>
			<br>
			<br>
			<img src="img/expen.jpg" width="100px">
			</div>
			<div class=col-md-2>
			<br>
			<img src="img/SME.png" width="100px">
			</div>
			</div>
<footer>

<div class="jumbotron jumbotron-foot text-center color:primary">
	<div><class="text-success font-size:22px color:#25d0d2" behavior="scroll" direction="left">BUSINESS TRAVEL MANAGEMENT SOLUTION <b>|&nbsp;&nbsp;</b> EXPENSE MANAGEMENT SOLUTION <b>|&nbsp;&nbsp;</b>GROUP REVENUE MANAGEMENT<b>|&nbsp;&nbsp;</b>AIRLINE FORECASTING TOOL<b>|&nbsp;&nbsp;</b>AIRLINE SME SOLUTION</marquee></div>
